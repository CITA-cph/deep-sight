...
{
    /// <summary>
    /// Iterative erosion / weathering simulation on a voxel density field.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    public class Cmpt_GridErosion : GH_Component
    {
        public Cmpt_GridErosion()
          : base("GridKPZErosion", "GEro",
              "Iterative 3D erosion / weathering of a voxel density field. Diffusion plus " +
              "surface-driven material loss, modulated by a fractal erodibility field.",
              DeepSight.GH.Api.ComponentCategory, "Tools")
        {
        }

        public override GH_Exposure Exposure { get { return GH_Exposure.secondary; } }
        protected override System.Drawing.Bitmap Icon { get { return Properties.Resources.GridErosion; } }
        public override Guid ComponentGuid { get { return new Guid("7e183cff-8912-4bc8-8395-e6c17f0de7d7"); } }
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            pManager.AddNumberParameter("Erosion", "g", "Erosion strength (surface material loss).", GH_ParamAccess.item, 0.5);
            ...
            pManager.AddNumberParameter("Threshold", "T",
                "Density below which a voxel is considered eroded away and dropped. For binary " +
                "occupancy data (a voxelised point cloud or mesh) 0.5 is the sensible cut.",
            ...
            pManager.AddBooleanParameter("ErodeOnly", "EO",
                "Material may only be removed, never added. Keep this on unless you specifically " +
                "want diffusion to spread material outward.",
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            double dt = 0.1, f = 0.5, g = 0.5, e = 1.0, h = 1.0, threshold = 0.5;
        ...
        {
            var outGrid = new FGrid("eroded", 0.0f);
            if (m_transform != null)
            {
            ...
            else
            {
                AddRuntimeMessage(GH_RuntimeMessageLevel.Warning,
                    "Everything eroded below the threshold - nothing left. Lower Erosion, Threshold, or dt.");
            }
